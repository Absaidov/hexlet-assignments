...
public class UsersServlet extends HttpServlet {
    ...
    private void createUser(HttpServletRequest request,
        ...
        Map<String, String> user = users.build(firstName, lastName, email, password);

        if (firstName.isEmpty() || email.isEmpty() || password.isEmpty()) {
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/new.jsp");
            request.setAttribute("user", user);
            session.setAttribute("flash", "Email, имя и пароль не могут быть пустыми");
    ...
    private void updateUser(HttpServletRequest request,
        ...
        Map<String, String> updatedUserData = users.build(firstName, lastName, email, password);
